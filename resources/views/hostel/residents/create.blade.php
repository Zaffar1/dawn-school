...
@section('title', 'Register Hostel Student/Staff')

@section('content')
<div class="page-title-box">
    <div>
        <h3 class="mb-1"><i class="fa-solid fa-user-plus me-2 text-primary"></i>Register Hostel Student/Staff</h3>
...
<div class="card-box" style="max-width: 800px;">
    <h5 class="text-primary mb-4"><i class="fa-solid fa-id-card me-2"></i>Person Details</h5>

    <form method="POST" action="{{ route('hostel.residents.store') }}">
        @csrf
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select name="resident_type" id="resident_type" class="form-select @error('resident_type') is-invalid @enderror" required>
                    <option value="student" {{ old('resident_type') === 'student' ? 'selected' : '' }}>Hostel Student</option>
                    <option value="staff" {{ old('resident_type') === 'staff' ? 'selected' : '' }}>Hostel Staff</option>
                </select>
                @error('resident_type')
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Name of person" value="{{ old('name') }}" required>
                @error('name')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="e.g. +923001234567" value="{{ old('phone') }}">
            ...
            <div class="col-md-6" id="room_number_container">
                ...
                <input type="text" name="room_number" id="room_number" class="form-control @error('room_number') is-invalid @enderror" placeholder="e.g. Room-101, Room-203" value="{{ old('room_number') }}" required>
                @error('room_number')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="number" step="0.01" name="monthly_fee" id="monthly_fee" class="form-control @error('monthly_fee') is-invalid @enderror" placeholder="0.00" value="{{ old('monthly_fee') }}" required>
                </div>
                @error('monthly_fee')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
            ...
            <div class="col-md-6" id="deposit_container">
                ...
                <div class="input-group">
                    <span class="input-group-text bg-light text-muted">Rs.</span>
                    <input type="number" step="0.01" name="deposit" id="deposit" class="form-control @error('deposit') is-invalid @enderror" placeholder="0.00" value="{{ old('deposit', '0.00') }}">
                </div>
                @error('deposit')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
            ...
            <div class="col-md-6">
                ...
                <input type="date" name="joining_date" class="form-control @error('joining_date') is-invalid @enderror" value="{{ old('joining_date', now()->toDateString()) }}" required>
                @error('joining_date')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-6">
                ...
                <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                    ...
                    <option value="inactive" {{ old('status') === 'inactive' ? 'selected' : '' }}>Inactive/Left</option>
                </select>
                @error('status')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="col-12">
                ...
                <textarea name="notes" id="notes" rows="3" class="form-control @error('notes') is-invalid @enderror" placeholder="Enter emergency contacts, instructions, or remarks...">{{ old('notes') }}</textarea>
                @error('notes')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-12 mt-4 d-flex gap-2">
                <button type="submit" class="btn btn-primary" id="submit_btn"><i class="fa-solid fa-floppy-disk me-1"></i> Register Student / Staff</button>
