...
@section('title', 'Register Hostel Resident/Staff')

@section('content')
<div class="page-title-box">
    <div>
        <h3 class="mb-1"><i class="fa-solid fa-user-plus me-2 text-primary"></i>Register Hostel Person</h3>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select name="resident_type" id="resident_type" class="form-select @error('resident_type') is-invalid @enderror" required>
                    <option value="resident" {{ old('resident_type') === 'resident' ? 'selected' : '' }}>Hostel Resident</option>
            ...
            <div class="col-12 mt-4 d-flex gap-2">
                <button type="submit" class="btn btn-primary" id="submit_btn"><i class="fa-solid fa-floppy-disk me-1"></i> Register Resident / Staff</button>
